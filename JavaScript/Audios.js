...
var insalata = new Audio("audios/insalata.mp3");
var manzana = new Audio("audios/manzana.mp3");
var pepperoni = new Audio("audios/pepperoni.mp3");
var pescado = new Audio("audios/pescado.mp3");
var pimienta = new Audio("audios/pimienta.mp3");
var zanahoria = new Audio("audios/zanahoria.mp3");
var seta = new Audio("audios/seta.mp3");
var buah = new Audio("audios/Buah.mp3");
